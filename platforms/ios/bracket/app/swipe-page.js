...
function pageLoaded(args) {
 ...
 //    var scrollView = view.getViewById(page, "challengeScrollView");

	var challenge = builder.load({
        path: "/app/",
        name: "loop1"
	});

	var challenge1 = builder.load({
        path: "/app/",
        name: "loop2"
	});

	absoluteLayout.addChild(challenge);

	page.bindingContext = { challenges: [challenge, challenge1] };

	var topmost = frameModule.topmost();
	// topmost.navigate("loop1");
